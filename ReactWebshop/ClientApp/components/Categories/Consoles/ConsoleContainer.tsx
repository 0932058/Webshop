...
export class ConsolesContainer  extends React.Component<RouteComponentProps<{}>, ICategoryState<console>> implements ICategory{
    constructor(){
        ...
        this.PrepareForConsoleQuery = this.PrepareForConsoleQuery.bind(this);
    ...
    componentWillMount(){
        ...
        this.PrepareForConsoleQuery(convertedPathToEnum).then(consoleListToShow => this.setState({foundProductToShow: consoleListToShow, categoryTitle:convertedPathLowercased, loaded: true}));  
    }
    ...
    PrepareForConsoleQuery(clickedOnSubCategory: consoleType): Promise<List<any>> {
